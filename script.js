...
const TEACHERS = [
  {name:'Mr. Rakhibul Ahmed', subject:'General Science', cat:'science', qual:'B.Sc.', bio:'Introduces science to the middle wing through observation walks around the school campus.', img: 'https://i.ibb.co/7J5975ST/image.png'},
   {name:'Mr. Moidul Islam Ahmed', subject:'General Science', cat:'science', qual:'B.Sc, LL.B', bio:'Introduces science to the middle wing through observation walks around the school campus', img:'https://i.ibb.co/d0j0qgzJ/image.png'}, 
